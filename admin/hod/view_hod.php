...
// ");
// $coursesStmt->bind_param("i", $hodId);
// $coursesStmt->execute();
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <div class="header">
                ...
                <a href="hod.php" class="btn">Back to hod</a>
            </div>
            
            <div class="profile-container">
                <div class="profile-sidebar">
                    <img src="<?php echo !empty($hod['profile_picture']) ? $hod['profile_picture'] : '../../assets/images/default-profile.png'; ?>" alt="Profile Picture" class="profile-picture">
                    
                    <div class="profile-details">
                        <h3><?php echo $hod['first_name'] . ' ' . $hod['last_name']; ?></h3>
                        <p><?php echo $hod['email']; ?></p>
                        <p><strong>hod</strong></p>
                        <p>Joined: <?php echo date('F j, Y', strtotime($hod['created_at'])); ?></p>
                    </div>
                    
                    <div class="profile-action">
                        <a href="edit_hod.php?id=<?php echo $hod['user_id']; ?>" class="btn">Edit hod</a>
                    </div>
                </div>
                ...
                <div class="profile-main">
                    ...
                    <?php else: ?> -->
                        <div class="no-courses">
                            <p>This hod is not assigned to any courses yet.</p>
